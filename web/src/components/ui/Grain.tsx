/** Fixed film-grain overlay: SVG turbulence, gently jittered. */
...
export function Grain() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-[60] overflow-hidden opacity-[0.085] mix-blend-screen">
      <div className="absolute -inset-[50%] animate-grain" style={{ backgroundImage: NOISE, backgroundSize: "220px 220px" }} />
    </div>
  );
}
